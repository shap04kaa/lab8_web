// создает кнопку страницы пагинации с номером page
...
// создает элемент с именем автора записи
...
//  создает элемент с количеством лайков записи
...
// отчистка списка записей и добавление новых
...
// очищает выпадающий список автозаполнения
...
// выполнения функции downloadData() при загрузке страницы и установки обработчиков событий для элементов интерфейса
